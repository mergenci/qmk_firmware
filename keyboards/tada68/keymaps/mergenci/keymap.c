...
[_FL] = LAYOUT_ansi(
  ...
  KC_LSFT,_______,_______,BL_DEC, BL_TOGG,BL_INC, _______,KC_MUTE,KC_VOLD,KC_VOLU,_______,_______, _______, KC_END, \
  KC_LCTL, KC_LALT, KC_LGUI,               _______,               _______,_______,_______,_______,_______, _______),
...
[_CL] = LAYOUT_ansi(
  ...
  _______, C(KC_LALT), /* EMACS_M */ OSL(_ML),          C(KC_SPC),               C(KC_RGUI), _______, _______, C(KC_LEFT), C(KC_DOWN), C(KC_RGHT)),
...
[_CX] = LAYOUT_ansi(
  ...
  /* Keymap _ML: Emacx M- layer
   * Disables emacs shortcuts defined in _CL layer, when preceded by Space-Cmd, so that they work in emacs.
   */
[_ML] = LAYOUT_ansi(
  KC_GESC, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS, KC_EQL,  KC_BSPC,    KC_GRV, \
  KC_TAB,  KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC, KC_RBRC,KC_BSLS,  KC_DEL, \
